        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/privacidad" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200">
                  Política de Privacidad
                </Link>
              </li>
              <li>
                <Link href="/terminos" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200">
                  Términos de Uso
                </Link>
              </li>
            </ul>
          ...
          {/* Locations & Social */}
          <div>
            <h4 className="text-lg font-semibold text-white mb-6">Ubicaciones</h4>
            <div className="space-y-4 mb-8">
              <div>
